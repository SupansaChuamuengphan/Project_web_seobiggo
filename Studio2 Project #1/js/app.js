new Vue({
 ...
 data: {
  ...
  products: [
  {
   id:1,
   name:'GOGUMA',
   description: 'บิงซูมันหวาน แทรกเนื้อชีสเค้กนุ่มหนึบ',
   price: 220,
   ...
   id:2,
   name:'MANGO CHEESE',
   description: 'บิงซูปุยหิมะเนื้อนุ่ม ราดด้วยซอสมะม่วงรสเปรี้ยว',
   price: 235,
   ...
   description: 'บิงซูชาเขียวพร้อมถั่วแดงกวนและอัลมอนด์สไลด์',
   price: 190,
   ...
   id:4,
   name:'OREO',
   description: 'สำหรับคนรักโอริโอ้ จัดกันไปเลยด้วยเมนูนี้',
   price: 220,
   ...
   id:5,
   name:'MELON ICECREAM',
   description: 'เนื้อเมล่อนฉ่ำกับไอศกรีมหวานหอมชื่นใจ',
   price: 235,
   ...
   id:6,
   name:'PAT',
   description: 'บิงซูเนื้อนุ่มคู่กับถั่วแดงกวนหวานมัน',
   price: 190,
